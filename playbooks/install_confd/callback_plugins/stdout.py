...
class CallbackModule(CallbackBase):
    ...
    CALLBACK_TYPE = 'installstdout'
    CALLBACK_NAME = 'confdstdout'
    CALLBACK_NEEDS_WHITELIST = False
   
    #def v2_on_any(self,*args, **kwargs):
        #self._display.display(self.play, color=C.COLOR_OK)
 
    def v2_playbook_on_start(self, playbook):
        self._display.display("Start", color=C.COLOR_OK)

    def v2_playbook_on_stats(self, stats):
        self._display.display('END', color=C.COLOR_OK)
